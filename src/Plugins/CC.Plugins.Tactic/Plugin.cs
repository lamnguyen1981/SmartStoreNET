...
namespace CC.Plugins.Tactic
{
    public class Plugin : BasePlugin, IWidget, IConfigurable
    {
        ...
        public const string SystemName = "CC.Plugins.Tactic";
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public void GetDisplayWidgetRoute(string widgetZone, object model, int storeId, out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary
                {
                    {"Namespaces", "CC.Plugins.Tactic.Controllers"},
                    {"area", "CC.Plugins.Tactic"},
            ...
            //    controllerName = "ProductTactic";
            //    routeValues = new RouteValueDictionary
            //    {
            //        {"Namespaces", "CC.Plugins.ChamberlainProductTactic.Controllers"},
            //        {"area", "CC.Plugins.ChamberlainProductTactic"},
            //        {"widgetZone", widgetZone}
            //        //{"additionalData", routeValues }
            //    };
            //}
